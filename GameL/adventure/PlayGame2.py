...
enemy_image = pygame.transform.scale(enemy_image, (int(enemy_image.get_width() * 0.2), int(enemy_image.get_height() * 0.2)))
gem_image = pygame.transform.scale(gem_image, (int(gem_image.get_width() * 0.1), int(gem_image.get_height() * 0.1)))
powerup_image = pygame.transform.scale(powerup_image, (int(powerup_image.get_width() * 0.3), int(powerup_image.get_height() * 0.3)))
...
while True:
    ...
    if game_state == GAME_RUNNING:
        ...
        draw_text('Game Paused - Press P to resume', white, screen_width // 2 - 150, screen_height // 2)
        pygame.display.flip()
